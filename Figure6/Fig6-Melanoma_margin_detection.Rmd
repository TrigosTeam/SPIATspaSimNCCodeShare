...
plot_cell_categories(primary, c("MEL","T","B","Ma","DC", "Undefined"),
                     c("red", "blue", "darkgreen", "purple","orange", "darkgray"), feature_colname = "Cell.Type")
...
plot_cell_categories(primary, categories_of_interest,
                     colour_vector = c("gray","red","darkblue","darkgreen","orange"),
...
plot_cell_categories(MET, categories_of_interest,
                     colour_vector = c("gray","red","orange","darkblue","darkgreen","purple"),
                     "Cell.Type", layered = TRUE, cex = 0.2)
start <- Sys.time()
...
plot_cell_categories(REL, categories_of_interest,
                     colour_vector = c("red","gray","darkblue","orange","darkgreen"),
                     "Cell.Type", cex = 0.2)
start <- Sys.time()
