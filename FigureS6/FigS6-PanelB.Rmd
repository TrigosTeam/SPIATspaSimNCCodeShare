...
plot_cell_categories(image_struc1, c("Tumour","Immune","Others"),c("red","darkgreen","lightgray"),"Cell.Type")
# dev.off()
```
...
plot_cell_categories(image_struc2, c("Tumour","Immune","Others"),c("red","darkgreen","lightgray"),"Cell.Type")
# dev.off()
...
plot_cell_categories(image_struc3, c("Tumour","Immune","Others"),c("red","darkgreen","lightgray"),"Cell.Type")
# dev.off()
